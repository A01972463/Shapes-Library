...
class TriangleTest {
    ...
    fun testTriangleConstruction() {
        ...
        assertEquals(1.0, Triangle.pointB.y)
    ...
    fun testTriangleGetArea() {
        assertEquals("1.000", Triangle.getArea())
    }
...
//        New Point
        ...
        Triangle.moveTriangle(newPointA, newPointB, newPointC)
...
//        Direct Point
        Triangle.moveTriangle(Point(-1.0, -1.0), Point(0.0, 2.0), Point(1.0, -1.0))
